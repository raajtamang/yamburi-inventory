...
const Page = (props: Props) => {
    ...
    return (
        <div className='salesorder'>
            <Profiletop />
            <div className='salesorder-main'>
                <div className='salesorder-main--top'>
                    <div className='salesorder-main--top_head'>
                        <h2>Sales Order</h2>
                    </div>
                    <div className='salesorder-main--top_bottom'>
                        <div className='salesorder-main--top_bottom__search'>
                        ...
                        <div className='salesorder-main--top_bottom__middle' >
                            <div onClick={() => setActivepaid("all")} className={activepaid === "all" ? "salesorder-main--top_bottom__middle-all activebtnFilter" : "salesorder-main--top_bottom__middle-all"}>
                                All
                            </div>

                            <div onClick={() => setActivepaid("paid")} className={activepaid === "paid" ? "salesorder-main--top_bottom__middle-paid activebtnFilter" : "salesorder-main--top_bottom__middle-paid"}>
                                Paid
                            </div>

                            <div onClick={() => setActivepaid("unpaid")} className={activepaid === "unpaid" ? "salesorder-main--top_bottom__middle-unpaid activebtnFilter" : "salesorder-main--top_bottom__middle-unpaid"}>
                                UnPaid
                            </div>

                        </div>

                        <div className='salesorder-main--top_bottom__neworder'>
                            <h3> +New Sales Order</h3>
                        </div>
                    </div>
                </div>
                <div className='salesorder-main--table'>
                        ...
                        <tbody>
                            ...
                            {tabledata.map((index, i) =>
                                <tr key={i}>
                                    ...
                                    <td className='tablebtndiv'><div className={index.stock=="Available"?'statusdata green':'statusdata blue' }>{index.stock}</div></td>
                                    <td>{index.total}</td>
                                    <td>{index.balance}</td>
