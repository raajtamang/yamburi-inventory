    ...
    return (
        <div className='vendor'>
            ...
            <div className='vendor-main'>
                <div className='vendor-main--top'>
                    <div className='vendor-main--top_head'>
                        <h2>Vendor</h2>
                    </div>
                    <div className='vendor-main--top_bottom'>
                        <div className='vendor-main--top_bottom__search'>
                        ...
                        <div className='vendor-main--top_bottom__newvendor'>
                            <h3> +New Vendors</h3>
                        </div>
                    </div>
                </div>
                <div className='vendor-main--table'>
