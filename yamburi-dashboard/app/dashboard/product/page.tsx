...
const Page = (props: Props) => {
    ...
    return (
        <div className='inventoryproduct'>
            <Profiletop />
            <div className='inventoryproduct-main'>
                <div className='inventoryproduct-main--top'>
                    <div className='inventoryproduct-main--top_head'>
                        <h2>Product</h2>
                    </div>
                    <div className='inventoryproduct-main--top_bottom'>
                        <div className='inventoryproduct-main--top_bottom__search'>
                        ...
                        <div className='inventoryproduct-main--top_bottom__newproduct'>
                            <h3> +New Product</h3>
                        </div>
                    </div>
                </div>
                <div className='inventoryproduct-main--table'>
                        ...
                        <tbody>
                            ...
                            {tabledata.map((index, i) =>
                                <tr key={i}>
                                    ...
                                    <td>{index.name}</td>
                                    <td>{index.price}</td>
                                    <td className='tablebtndiv'><div className='statusdata'>{index.deal}</div></td>
                                    <td className='tablebtndiv'><div className='statusdata'>{index.coupon}</div></td>
                                    
                                    <td className='tablebtndiv'><div className='statusdata'>{index.review}</div></td>
